<?php include 'inc/config.php'; $template['footer'] = 'footer-fixed'; $template['header'] = 'navbar-fixed-top'; ?>
...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-show_big_thumbnails"></i>Fixed Top Header + Footer<br><small> + Fixed Sidebars</small>
            </h1>
        </div>
    </div>
