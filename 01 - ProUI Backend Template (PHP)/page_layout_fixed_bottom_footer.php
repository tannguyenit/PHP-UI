<?php include 'inc/config.php'; $template['footer'] = 'footer-fixed'; $template['header'] = 'navbar-fixed-bottom'; ?>
<?php include 'inc/template_start.php'; ?>
<?php include 'inc/page_head.php'; ?>

<!-- Page content -->
<div id="page-content">
    <!-- Fixed Bottom Header + Footer Header -->
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-show_big_thumbnails"></i>Fixed Bottom Header + Footer<br><small> + Fixed Sidebars</small>
            </h1>
        </div>
    </div>
    <ul class="breadcrumb breadcrumb-top">
        <li>Page Layouts</li>
        <li><a href="">Fixed Bottom Header + Footer</a></li>
    </ul>
    <!-- END Fixed Bottom Header + Footer Header -->
