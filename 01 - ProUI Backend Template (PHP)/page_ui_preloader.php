...
<div id="page-content">
    ...
    <div class="block">
        ...
        <p>
            <button class="btn btn-sm btn-primary" onclick="$('body').addClass('page-loading');setTimeout(function(){$('body').removeClass('page-loading');},3000);$(this).blur();">Preview Loading Screen for 3 seconds!</button>
        </p>
        <!-- END Usage Content -->
    </div>
    <!-- END Usage Block -->
