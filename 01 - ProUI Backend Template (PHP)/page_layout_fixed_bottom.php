<?php include 'inc/config.php'; $template['header'] = 'navbar-fixed-bottom'; ?>
<?php include 'inc/template_start.php'; ?>
<?php include 'inc/page_head.php'; ?>

<!-- Page content -->
<div id="page-content">
    <!-- Fixed Bottom Header Header -->
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-show_big_thumbnails"></i>Fixed Bottom Header<br><small> + Fixed Sidebars</small>
            </h1>
        </div>
    </div>
    <ul class="breadcrumb breadcrumb-top">
        <li>Page Layouts</li>
        <li><a href="">Fixed Bottom Header</a></li>
    </ul>
    <!-- END Fixed Bottom Header Header -->
